...
import styles, { voteAverage } from './MovieDetails.module.scss';
    ...
    return (
        <div className={styles.MovieDetails}>
            <div className={styles.header}>
                <Logo />
                <Button onClick={onClick} type="button" title="🔎" styleType="searchIcon" />
            </div>
            <div className={styles.movie}>
                <div className={styles.image}>
                    <ImgWithErrorHandling src={data.poster_path} alt="Movie poster" />
                </div>
